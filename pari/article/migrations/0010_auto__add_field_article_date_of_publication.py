...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.date_of_publication'
        db.add_column(u'article_article', 'date_of_publication',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.date_of_publication'
        db.delete_column(u'article_article', 'date_of_publication')
    ...
    models = {
        'article.article': {
            ...
            'date_of_publication': ('django.db.models.fields.DateField', [], {'null': 'True'}),
