...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.allow_featured_image'
        db.add_column(u'article_article', 'allow_featured_image',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.allow_featured_image'
        db.delete_column(u'article_article', 'allow_featured_image')
