...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArticleCarouselImage'
        db.create_table(u'article_articlecarouselimage', (
            ...
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(related_name='carousel_images', to=orm['article.Article'])),
        ...
        db.send_create_signal('article', ['ArticleCarouselImage'])


    def backwards(self, orm):
        # Deleting model 'ArticleCarouselImage'
        db.delete_table(u'article_articlecarouselimage')
