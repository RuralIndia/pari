...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'article', ['Type'])
        ...
        db.create_table(u'article_article_types', (
            ...
            ('type', models.ForeignKey(orm[u'article.type'], null=False))
        ))
    ...
    models = {
        u'article.article': {
            ...
            'types': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['article.Type']", 'symmetrical': 'False'}),
