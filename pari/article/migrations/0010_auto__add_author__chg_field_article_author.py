...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'article_article', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['article.Author']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Article.author'
        db.alter_column(u'article_article', 'author', self.gf('django.db.models.fields.CharField')(max_length=100))
