...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.oembed_data'
        db.add_column(u'article_article', 'oembed_data',
                      self.gf('django.db.models.fields.TextField')(default='{}', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.oembed_data'
        db.delete_column(u'article_article', 'oembed_data')
    ...
    models = {
        'article.article': {
            ...
            'oembed_data': ('django.db.models.fields.TextField', [], {'default': "'{}'", 'null': 'True', 'blank': 'True'}),
