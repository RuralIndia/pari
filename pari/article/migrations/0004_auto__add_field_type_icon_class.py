...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Type.icon_class'
        db.add_column(u'article_type', 'icon_class',
                      self.gf('django.db.models.fields.CharField')(default='icon-facetime-video', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Type.icon_class'
        db.delete_column(u'article_type', 'icon_class')
    ...
    models = {
        u'article.article': {
            ...
            'types': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'articles'", 'symmetrical': 'False', 'to': u"orm['article.Type']"}),
