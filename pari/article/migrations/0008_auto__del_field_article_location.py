...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Article.location'
        db.delete_column(u'article_article', 'location_id')
    ...
    def backwards(self, orm):
        # Adding field 'Article.location'
        db.add_column(u'article_article', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['article.Location']),
                      keep_default=False)
