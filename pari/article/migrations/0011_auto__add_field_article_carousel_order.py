...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.carousel_order'
        db.add_column(u'article_article', 'carousel_order',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.carousel_order'
        db.delete_column(u'article_article', 'carousel_order')
