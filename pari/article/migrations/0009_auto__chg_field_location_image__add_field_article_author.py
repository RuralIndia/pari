...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.image'
        db.alter_column(u'article_location', 'image', self.gf('mezzanine.core.fields.FileField')(max_length=255, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Location.image'
        db.alter_column(u'article_location', 'image', self.gf('mezzanine.core.fields.FileField')(default='', max_length=255))
