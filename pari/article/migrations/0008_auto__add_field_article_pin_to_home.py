...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.pin_to_home'
        db.add_column(u'article_article', 'pin_to_home',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.pin_to_home'
        db.delete_column(u'article_article', 'pin_to_home')
