...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Article.capsule_video'
        db.add_column(u'article_article', 'capsule_video',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Article.capsule_video'
        db.delete_column(u'article_article', 'capsule_video')
