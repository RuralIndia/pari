...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.featured_audio'
        db.alter_column(u'article_article', 'featured_audio', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'Article.featured_video'
        db.alter_column(u'article_article', 'featured_video', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Article.featured_audio'
        db.alter_column(u'article_article', 'featured_audio', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Article.featured_video'
        db.alter_column(u'article_article', 'featured_video', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        'article.article': {
            ...
            'featured_audio': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            ...
            'featured_video': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        'article.author': {
            ...
            'expiry_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'facebook_username': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'gen_description': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
