...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'article_author', 'email',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Author.twitter_username'
        db.add_column(u'article_author', 'twitter_username',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Author.facebook_username'
        db.add_column(u'article_author', 'facebook_username',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Author.website'
        db.add_column(u'article_author', 'website',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'article_author', 'email')

        # Deleting field 'Author.twitter_username'
        db.delete_column(u'article_author', 'twitter_username')

        # Deleting field 'Author.facebook_username'
        db.delete_column(u'article_author', 'facebook_username')

        # Deleting field 'Author.website'
        db.delete_column(u'article_author', 'website')
