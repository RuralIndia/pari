...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Link.html_class'
        db.add_column(u'pages_link', u'html_class',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Link.html_class'
        db.delete_column(u'pages_link', u'html_class')


    models = {
        u'pages.link': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'Link', '_ormbases': [u'pages.Page']},
            u'html_class': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
