...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Factoid.external_link'
        db.add_column(u'resources_factoid', 'external_link',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Factoid.external_link'
        db.delete_column(u'resources_factoid', 'external_link')
