...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'resources_factoid', (
            ...
            ('resource', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='factoid', null=True, to=orm['resources.Resource'])),
        ...
        db.send_create_signal('resources', ['Factoid'])
    ...
    models = {
        ...
        'resources.factoid': {
            ...
            'resource': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'factoid'", 'null': 'True', 'to': "orm['resources.Resource']"}),
