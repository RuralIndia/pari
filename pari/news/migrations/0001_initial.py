...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LatestArticle'
        db.create_table(u'news_latestarticle', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('news', ['LatestArticle'])

        # Adding M2M table for field new_current_articles on 'LatestArticle'
        m2m_table_name = db.shorten_name(u'news_latestarticle_new_current_articles')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('latestarticle', models.ForeignKey(orm['news.latestarticle'], null=False)),
            ('article', models.ForeignKey(orm['article.article'], null=False))
        ))
        db.create_unique(m2m_table_name, ['latestarticle_id', 'article_id'])

        # Adding M2M table for field new_archive_articles on 'LatestArticle'
        m2m_table_name = db.shorten_name(u'news_latestarticle_new_archive_articles')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('latestarticle', models.ForeignKey(orm['news.latestarticle'], null=False)),
            ('article', models.ForeignKey(orm['article.article'], null=False))
    ...
    def backwards(self, orm):
        # Deleting model 'LatestArticle'
        db.delete_table(u'news_latestarticle')

        # Removing M2M table for field new_current_articles on 'LatestArticle'
        db.delete_table(db.shorten_name(u'news_latestarticle_new_current_articles'))

        # Removing M2M table for field new_archive_articles on 'LatestArticle'
        db.delete_table(db.shorten_name(u'news_latestarticle_new_archive_articles'))
    ...
    models = {
        ...
        'news.latestarticle': {
            'Meta': {'object_name': 'LatestArticle'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'new_archive_articles': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'new_archive_articles'", 'blank': 'True', 'to': "orm['article.Article']"}),
            'new_current_articles': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'new_current_articles'", 'blank': 'True', 'to': "orm['article.Article']"})
        },
        u'sites.site': {
