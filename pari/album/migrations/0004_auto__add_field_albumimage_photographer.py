...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlbumImage.photographer'
        db.add_column(u'album_albumimage', 'photographer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='photographs', to=orm['article.Author']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlbumImage.photographer'
        db.delete_column(u'album_albumimage', 'photographer_id')
