...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlbumImage.image_file'
        db.add_column(u'album_albumimage', 'image_file',
                      self.gf('mezzanine.core.fields.FileField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlbumImage.image_file'
        db.delete_column(u'album_albumimage', 'image_file')
