...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ImageCollectionImage'
        db.create_table(u'album_imagecollectionimage', (
            ...
            ('image_collection', self.gf('django.db.models.fields.related.ForeignKey')(related_name='images', to=orm['album.ImageCollection'])),
        ...
        db.send_create_signal('album', ['ImageCollectionImage'])

        # Adding model 'ImageCollection'
        db.create_table(u'album_imagecollection', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keywords_string', self.gf('django.db.models.fields.CharField')(max_length=500, blank=True)),
            ('site', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=500)),
        ...
        db.send_create_signal('album', ['ImageCollection'])

        # Adding field 'Album.image_collection'
        db.add_column(u'album_album', 'image_collection',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['album.ImageCollection']),
                      keep_default=False)

        # Deleting field 'AlbumImage.file'
        db.delete_column(u'album_albumimage', 'file')

        # Adding field 'AlbumImage.image_collection_image'
        db.add_column(u'album_albumimage', 'image_collection_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['album.ImageCollectionImage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ImageCollectionImage'
        db.delete_table(u'album_imagecollectionimage')

        # Deleting model 'ImageCollection'
        db.delete_table(u'album_imagecollection')

        # Deleting field 'Album.image_collection'
        db.delete_column(u'album_album', 'image_collection_id')

        # Adding field 'AlbumImage.file'
        db.add_column(u'album_albumimage', 'file',
                      self.gf('mezzanine.core.fields.FileField')(default=1, max_length=200),
                      keep_default=False)

        # Deleting field 'AlbumImage.image_collection_image'
        db.delete_column(u'album_albumimage', 'image_collection_image_id')
    ...
    models = {
        ...
        'album.albumimage': {
            ...
            'gen_description': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_collection_image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['album.ImageCollectionImage']"}),
            'in_sitemap': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
