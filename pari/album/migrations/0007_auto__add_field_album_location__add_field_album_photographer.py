...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Album.location'
        db.add_column(u'album_album', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='albums', blank=True, to=orm['article.Location']),
                      keep_default=False)

        # Adding field 'Album.photographer'
        db.add_column(u'album_album', 'photographer',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='albums', blank=True, to=orm['article.Author']),
                      keep_default=False)

        # Removing M2M table for field location on 'Album'
        db.delete_table('album_album_location')


    def backwards(self, orm):
        # Deleting field 'Album.location'
        db.delete_column(u'album_album', 'location_id')

        # Deleting field 'Album.photographer'
        db.delete_column(u'album_album', 'photographer_id')

        # Adding M2M table for field location on 'Album'
        db.create_table(u'album_album_location', (
        ...
        db.create_unique(u'album_album_location', ['album_id', 'location_id'])
    ...
    models = {
        u'album.album': {
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'albums'", 'blank': 'True', 'to': "orm['article.Location']"}),
            'meta_data': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'photographer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'albums'", 'blank': 'True', 'to': "orm['article.Author']"}),
