...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlbumImage.keywords_string'
        db.add_column(u'album_albumimage', 'keywords_string',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True),
                      keep_default=False)

        # Adding field 'AlbumImage.site'
        db.add_column(u'album_albumimage', 'site',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']),
                      keep_default=False)

        # Adding field 'AlbumImage.title'
        db.add_column(u'album_albumimage', 'title',
                      self.gf('django.db.models.fields.CharField')(default='no title', max_length=500),
                      keep_default=False)

        # Adding field 'AlbumImage.slug'
        db.add_column(u'album_albumimage', 'slug',
                      self.gf('django.db.models.fields.CharField')(max_length=2000, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AlbumImage._meta_title'
        db.add_column(u'album_albumimage', '_meta_title',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AlbumImage.gen_description'
        db.add_column(u'album_albumimage', 'gen_description',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'AlbumImage.status'
        db.add_column(u'album_albumimage', 'status',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'AlbumImage.publish_date'
        db.add_column(u'album_albumimage', 'publish_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AlbumImage.expiry_date'
        db.add_column(u'album_albumimage', 'expiry_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AlbumImage.short_url'
        db.add_column(u'album_albumimage', 'short_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'AlbumImage.in_sitemap'
        db.add_column(u'album_albumimage', 'in_sitemap',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'AlbumImage.description'
        db.alter_column(u'album_albumimage', 'description', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting field 'AlbumImage.keywords_string'
        db.delete_column(u'album_albumimage', 'keywords_string')

        # Deleting field 'AlbumImage.site'
        db.delete_column(u'album_albumimage', 'site_id')

        # Deleting field 'AlbumImage.title'
        db.delete_column(u'album_albumimage', 'title')

        # Deleting field 'AlbumImage.slug'
        db.delete_column(u'album_albumimage', 'slug')

        # Deleting field 'AlbumImage._meta_title'
        db.delete_column(u'album_albumimage', '_meta_title')

        # Deleting field 'AlbumImage.gen_description'
        db.delete_column(u'album_albumimage', 'gen_description')

        # Deleting field 'AlbumImage.status'
        db.delete_column(u'album_albumimage', 'status')

        # Deleting field 'AlbumImage.publish_date'
        db.delete_column(u'album_albumimage', 'publish_date')

        # Deleting field 'AlbumImage.expiry_date'
        db.delete_column(u'album_albumimage', 'expiry_date')

        # Deleting field 'AlbumImage.short_url'
        db.delete_column(u'album_albumimage', 'short_url')

        # Deleting field 'AlbumImage.in_sitemap'
        db.delete_column(u'album_albumimage', 'in_sitemap')


        # Changing field 'AlbumImage.description'
        db.alter_column(u'album_albumimage', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000))

    models = {
        u'album.album': {
            'Meta': {'object_name': 'Album'},
            '_meta_title': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'articles': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['article.Article']", 'symmetrical': 'False', 'blank': 'True'}),
            ...
            'location': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['article.Location']", 'symmetrical': 'False', 'blank': 'True'}),
            'meta_data': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'predominant_tone': ('django.db.models.fields.CharField', [], {'default': "'colour'", 'max_length': '10'}),
