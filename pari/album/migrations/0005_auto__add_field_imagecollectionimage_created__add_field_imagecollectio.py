...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ImageCollectionImage.created'
        db.add_column(u'album_imagecollectionimage', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'ImageCollectionImage.updated'
        db.add_column(u'album_imagecollectionimage', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'ImageCollection.created'
        db.add_column(u'album_imagecollection', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'ImageCollection.updated'
        db.add_column(u'album_imagecollection', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Album.created'
        db.add_column(u'album_album', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Album.updated'
        db.add_column(u'album_album', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'AlbumImage.created'
        db.add_column(u'album_albumimage', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'AlbumImage.updated'
        db.add_column(u'album_albumimage', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ImageCollectionImage.created'
        db.delete_column(u'album_imagecollectionimage', 'created')

        # Deleting field 'ImageCollectionImage.updated'
        db.delete_column(u'album_imagecollectionimage', 'updated')

        # Deleting field 'ImageCollection.created'
        db.delete_column(u'album_imagecollection', 'created')

        # Deleting field 'ImageCollection.updated'
        db.delete_column(u'album_imagecollection', 'updated')

        # Deleting field 'Album.created'
        db.delete_column(u'album_album', 'created')

        # Deleting field 'Album.updated'
        db.delete_column(u'album_album', 'updated')

        # Deleting field 'AlbumImage.created'
        db.delete_column(u'album_albumimage', 'created')

        # Deleting field 'AlbumImage.updated'
        db.delete_column(u'album_albumimage', 'updated')
    ...
    models = {
        'album.album': {
            ...
            'location': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'albums'", 'null': 'True', 'to': "orm['article.Location']"}),
            'meta_data': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'photographer': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'albums'", 'null': 'True', 'to': "orm['article.Author']"}),
        ...
        'album.albumimage': {
            ...
            'album': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'images'", 'to': "orm['album.Album']"}),
            'audio': ('django.db.models.fields.CharField', [], {'max_length': '30', 'null': 'True', 'blank': 'True'}),
            'audio_file': ('django.db.models.fields.files.FileField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'expiry_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'gen_description': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_collection_image': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'album_image'", 'to': "orm['album.ImageCollectionImage']"}),
            ...
            'photographer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'photographs'", 'to': "orm['article.Author']"}),
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'short_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['sites.Site']"}),
            'slug': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
