...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlbumImage.location'
        db.add_column(u'album_albumimage', 'location',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['article.Location'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlbumImage.location'
        db.delete_column(u'album_albumimage', 'location_id')
