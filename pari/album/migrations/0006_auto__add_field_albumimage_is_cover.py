...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlbumImage.is_cover'
        db.add_column(u'album_albumimage', 'is_cover',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlbumImage.is_cover'
        db.delete_column(u'album_albumimage', 'is_cover')
