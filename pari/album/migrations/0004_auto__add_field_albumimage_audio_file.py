...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlbumImage.audio_file'
        db.add_column(u'album_albumimage', 'audio_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlbumImage.audio_file'
        db.delete_column(u'album_albumimage', 'audio_file')
    ...
    models = {
        ...
        'album.albumimage': {
            ...
            'audio_file': ('django.db.models.fields.files.FileField', [], {'max_length': '200', 'null': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'expiry_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'gen_description': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
