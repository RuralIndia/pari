...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Album.location'
        db.alter_column(u'album_album', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['article.Location']))

        # Changing field 'Album.photographer'
        db.alter_column(u'album_album', 'photographer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['article.Author']))

    def backwards(self, orm):

        # Changing field 'Album.location'
        db.alter_column(u'album_album', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['article.Location']))

        # Changing field 'Album.photographer'
        db.alter_column(u'album_album', 'photographer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['article.Author']))
