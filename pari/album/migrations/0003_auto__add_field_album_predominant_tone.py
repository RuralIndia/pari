...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Album.predominant_tone'
        db.add_column(u'album_album', 'predominant_tone',
                      self.gf('django.db.models.fields.CharField')(default='colour', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Album.predominant_tone'
        db.delete_column(u'album_album', 'predominant_tone')
