...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Face.district'
        db.delete_column(u'faces_face', 'district')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Face.district'
        raise RuntimeError("Cannot reverse this migration. 'Face.district' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Face.district'
        db.add_column(u'faces_face', 'district',
