...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'faces_district', (
            ...
            ('district_description', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
        ))
        db.send_create_signal('faces', ['District'])


    def backwards(self, orm):
        # Deleting model 'District'
        db.delete_table(u'faces_district')
