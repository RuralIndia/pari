...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Face.is_pinned'
        db.add_column(u'faces_face', 'is_pinned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'FaceImage.is_cover'
        db.delete_column(u'faces_faceimage', 'is_cover')

        # Adding field 'FaceImage.is_pinned'
        db.add_column(u'faces_faceimage', 'is_pinned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Face.is_pinned'
        db.delete_column(u'faces_face', 'is_pinned')

        # Adding field 'FaceImage.is_cover'
        db.add_column(u'faces_faceimage', 'is_cover',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'FaceImage.is_pinned'
        db.delete_column(u'faces_faceimage', 'is_pinned')
